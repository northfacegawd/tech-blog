      ...
      <div className="mx-auto flex max-w-4xl flex-wrap">
        <div className="card text-gray-800 font-light w-full mt-4 md:w-[48%] md:m-[1%]">
          ...
          <p className="mt-6 indent-4">
            글이 읽기 쉽다는 것은 글의 구조가 명확하게 잡혀 있고, 글의 흐름이
            자연스럽게 이어져 독자가 기승전결을 한 눈에 파악할 수 있는 상태를
            의미합니다.
          </p>
          <p className="mt-6 indent-4">
        ...
        <div className="card text-gray-800 font-light w-full mt-4 md:w-[48%] md:m-[1%]">
          <h3 className="text-2xl">
            <span className="text-black font-normal">겸손한 글</span>을 씁니다
          </h3>
          <p className="mt-6 indent-4">
            누구에게나 주니어인 시절이 있었기에, 항상 초심을 잃지 않고 겸손함을
            추구하여야 합니다.
          </p>
          <p className="mt-6 indent-4">
        ...
        <div className="card text-gray-800 font-light w-full mt-4 md:w-[48%] md:m-[1%]">
          <h3 className="text-2xl">
            <span className="text-black font-normal">친절한 글</span>을 씁니다
          </h3>
          <p className="mt-6 indent-4">
            만약 내가 쓴 글이 하나의 제품이라고 생각한다면, 독자는 제 고객과도
            같습니다.
          </p>
          <p className="mt-6 indent-4">
            만약 내가 쓴 글이 하나의 제품이라고 생각한다면, 독자는 제 고객과도
        ...
        <div className="card text-gray-800 font-light w-full mt-4 md:w-[48%] md:m-[1%]">
          <h3 className="text-2xl">
            <span className="text-black font-normal">재미있는 글</span>을 씁니다
          </h3>
          <p className="mt-6 indent-4">
          ...
          <p className="mt-6 indent-4">
            정보와 재미가 적절하게 균형을 갖춘 글은 독자에게 깊은 인상을 줄 수
            있으므로 오래동안 기억에 남을 수 있습니다.
          </p>
        </div>
      </div>
    </section>
