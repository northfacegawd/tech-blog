...
export default function SeventhSection() {
  ...
  return (
    <section className="w-full relative" ref={sectionRef}>
      ...
      <p
        className="text-shadow-xl transition-colors duration-300 fixed top-[55vh] md:top-[50vh] left-[10vw] w-full z-20 text-2xl md:text-5xl hidden opacity-0 max-w-[80vw] text-white"
        ref={pRef}
      >
        포스트를 넘어 콘텐츠로,
        <br />
