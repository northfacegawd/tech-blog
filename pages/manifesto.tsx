    ...
    <div className="pt-14 w-full">
      <section className="w-full bg-slate-200 dark:bg-gray-800">
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          <blockquote className="bg-gray-600 p-12 rounded-lg border-l-8 border-gray-400">
          ...
          <p className="my-8 indent-4">
            ...
            이유는 개발자로 취업을 하고 나서부터 경험한 지식들을 글로써
            정리하고자 하는 목적이었습니다. 하지만 운영 초반에는 글쓰기에 대한
            노하우도 부족했고 방문자도 많지 않다보니, 글을 쓰는 것이 마치 벽에
            대고 소리를 지르는 것처럼 공허하다는 느낌이 들었습니다.
          </p>
          <p className="my-8 indent-4">
            저는 이것이 글을 쓰는 이유와 목적, 즉 당위성에 대한 고민이 충분하지
            않았기 때문에 생긴 고민이라고 판단했습니다. 그래서 저는 글쓰기를
            통해 이루고자 하는 바가 무엇이며, 어떤 글을 쓰는 사람으로 기억되고
            싶은지를 고민했고, 이것을 포스트로 작성하기도 했습니다.
          </p>
          <p className="my-8 indent-4">
          ...
          <p className="my-8 indent-4">
            애자일 매니페스토(Agile Manifesto)가 소프트웨어 공학에서 널리
            인정받는 원칙인 것처럼, 누군가에게도 이 매니페스토가 기술 글쓰기의
            원칙이 될 수 있기를 바라며 그 내용을 공개합니다.
          </p>
        </div>
      </section>
      <section />
